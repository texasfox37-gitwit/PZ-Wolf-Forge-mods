...
- Copies required Java compatibility DLLs from your existing Project Zomboid `jre64` folder into the game root when needed.
...
- Includes uninstall scripts that remove the bridge launch entries again.
